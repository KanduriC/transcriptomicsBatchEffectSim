...
row_vars_batch <- matrixStats::rowVars(as.matrix(data_objs_batch$train_data))

test_that("simulation of exprs with batch and group effects works", {
  expect_equal(round(min(row_vars_batch)), 32939)
})
